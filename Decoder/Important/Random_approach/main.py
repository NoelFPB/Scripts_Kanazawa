...
voltage_range = [0.1, 2.5, 3.3, 4.9]  # Possible random voltages
...
def main():
    ...
    for config_num in range(100):  # Test 100 random configurations
        ...
        for input_state in input_combinations:
            # Apply InputState to heaters 36 and 37
    ...
    with open('decoder_test_results_with_configurations.csv', 'w', newline='') as csvfile:
        ...
        writer.writerow(["ConfigNumber", "InputState_Heater36", "InputState_Heater37", 
