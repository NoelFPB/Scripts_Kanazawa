...
def main():
        ...
        if dominance_results and score < best_score:
            ...
            if score == 0:
                ...
                for input_state in input_combinations:
                    ...
                    for _, row in refined_df[refined_df['InputState_Heater36'] == input_state[0]].iterrows():
                        print({
                            'Output1': row['Output1'],
                            'Output2': row['Output2'],
                            'Output3': row['Output3'],
    ...
    pd.DataFrame(iteration_results).to_csv('refined_single_decoder_configuration.csv', index=False)
    print("Refined configuration saved to 'refined_single_decoder_configuration.csv'.")
