...
class WavelengthSweepMeasurement:
    ...
    def save_results(self):
        ...
        json_filename = f"wavelength_sweep_{timestamp}.json"
        json_data = {
            'measurement_info': {
                'timestamp': datetime.now().isoformat(),
                'wavelength_range': f"{WAVELENGTH_START}-{WAVELENGTH_END}nm",
                'wavelength_step': WAVELENGTH_STEP,
                'input_combinations': INPUT_COMBINATIONS,
                'base_config': self.base_config,
                'laser_settling_time': LASER_SETTLING_TIME,
                'heater_settling_time': HEATER_SETTLING_TIME,
                'measurements_per_point': NUM_MEASUREMENTS_PER_POINT
            },
        ...
        # Save as CSV (tabular data for easy analysis)
...
def main():
    ...
    custom_base_config = {0: 3.604, 1: 4.431, 2: 1.449, 3: 0.592, 4: 2.355, 5: 3.185, 6: 1.209, 7: 4.014, 8: 0.49, 9: 1.039, 10: 2.516, 11: 1.969, 12: 3.743, 13: 2.029, 14: 2.752, 15: 2.726, 16: 0.778, 17: 4.9, 18: 4.352, 19: 2.148, 20: 2.291, 21: 2.351, 22: 4.522, 23: 1.234, 24: 2.833, 25: 3.353, 26: 2.481, 27: 4.48, 28: 2.459, 29: 1.297, 30: 4.449, 31: 4.524, 32: 2.214, 33: 0.01, 34: 0.01, 35: 0.01, 36: 0.0, 37: 0.0, 38: 0.01, 39: 0.01}
