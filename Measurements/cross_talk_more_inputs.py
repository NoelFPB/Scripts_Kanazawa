...
def run_automated_report(scope, ser, current_heater_state_base, gates_info, all_combined_input_states, channels_to_monitor):
    ...
    """
    print("\n--- Running Automated Full Test and Report ---")
    ...
    for gate in gates_info:
        gate_results[gate['name']] = {
            ...
            'per_combination_data': [] # Store detailed results for each combined state
        }
    ...
    excel_header_row = ["Combined Inputs"]
    ...
    for i, combined_input_heater_values in enumerate(all_combined_input_states):
        ...
        current_excel_row = []
        input_heaters_in_order = get_all_input_heaters(gates_info) # Get all unique inputs sorted
        input_combo_str_for_display = ", ".join([f"H{h}={combined_input_heater_values[h]:.1f}V" for h in input_heaters_in_order])
        current_excel_row.append(input_combo_str_for_display)
        
        # Add individual input heater values to the Excel row
        for h_id in input_heaters_in_order:
        ...
        for gate in gates_info:
            ...
            measured_output_str_for_display = "N/A"


            if measured_output is not None:
                measured_output_str_for_display = f"{measured_output:.4f}V"
    ...
    # --- Export to Excel ---
    report_filename = "multi_gate_test_report.xlsx"
    try:
...
def main():
    ...
    try:
        ...
        optimized_heater_config = {
            0: 4.9, 1: 0.43, 2: 1.095, 3: 0.794, 4: 4.9, 5: 3.854, 6: 1.898, 7: 4.792,
            8: 4.391, 9: 0.329, 10: 4.9, 11: 0.733, 12: 4.9, 13: 4.575, 14: 4.264, 15: 1.508,
            16: 0.119, 17: 3.146, 18: 4.019, 19: 4.548, 20: 0.108, 21: 1.531, 22: 4.9, 23: 2.837,
            24: 4.9, 25: 0.1, 26: 0.9, 27: 4.803, 28: 4.9, 29: 3.275, 30: 4.896, 31: 0.1,
            32: 0.19, 33: 0.0, 34: 0.0, 35: 0.01, 36: 0.0, 37: 0.0, 38: 0.0, 39: 0.0
        }
        ...
        mode = "main_menu" # State variable: "main_menu", "individual_gate_selection", "individual_gate_test", "all_gates_test", "automated_report"
